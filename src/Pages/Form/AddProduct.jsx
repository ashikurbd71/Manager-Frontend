...
const AddProduct = () => {
    ...
    return (
        ...
        <div className='p-8'>
            ...
            <div>
                <form onSubmit={formik.handleSubmit} className='w-[500px] bg-white p-8 rounded-md'>
                    <div className='grid grid-cols-1 gap-4'>
                        {/* Product SL */}
                        <div className='flex flex-col'>
                            <label htmlFor="productsl">1. Product SL <span className='text-xl font-semibold text-red-500'>*</span></label>
                            <input
                                id="productsl"
                                name="productsl"
                        ...
                        {/* Product Name */}
                        <div className='flex flex-col'>
                            <label htmlFor="productname">2. Product Name <span className='text-xl font-semibold text-red-500'>*</span></label>
                            <input
                                id="productname"
                                name="productname"
                                className='py-2 border-2 border-neutral-800 px-3 w-full'
                        ...
                        {/* Product Details */}
                        <div className='flex flex-col'>
                            <label htmlFor="productnamedetails">3. Product Details <span className='text-xl font-semibold text-red-500'>*</span></label>
                            <input
                            ...
                            />
                            {formik.touched.productnamedetails && formik.errors.productnamedetails ? (
                                <div className="text-red-600">{formik.errors.productnamedetails}</div>
                            ) : null}
                        </div>

                        {/* Cost */}
                        <div className='flex flex-col'>
                            <label htmlFor="cost">5. Cost <span className='text-xl font-semibold text-red-500'>*</span></label>
                            <input
                                id="cost"
                                name="cost"
                                className='py-2 border-2 border-neutral-800 px-3 w-full'
                        ...
                        {/* Sell Amount */}
                        <div className='flex flex-col'>
                            <label htmlFor="sellamount">4. Sell Amount <span className='text-xl font-semibold text-red-500'>*</span></label>
                            <input
                                id="sellamount"
                                name="sellamount"
                                className='py-2 border-2 border-neutral-800 px-3 w-full'
                    ...
                    <div className='flex items-center gap-4'>
                        <button className='w-[100px] mt-10 rounded-lg h-[40px] border-2 border-[#0284C7]' type="submit">Submit</button>
                        <button
